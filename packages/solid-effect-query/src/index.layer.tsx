import { createContext, useContext, onCleanup, createComponent, type ParentComponent } from "solid-js";
...
>(
  ...
  useEffectQuery: ReturnType<typeof Hooks.makeUseEffectQuery<R, ManagedRuntime.ManagedRuntime<R, E>>>;
  useEffectMutation: ReturnType<typeof Hooks.makeUseEffectMutation<R, ManagedRuntime.ManagedRuntime<R, E>>>;
} {
  ...
  const useEffectQuery = Hooks.makeUseEffectQuery<R, ManagedRuntime.ManagedRuntime<R, E>>(useEffectRuntime);
  const useEffectMutation = Hooks.makeUseEffectMutation<R, ManagedRuntime.ManagedRuntime<R, E>>(useEffectRuntime);
